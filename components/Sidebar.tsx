  ...
  return (
    <aside className="no-print w-full md:w-80 bg-white border-r border-slate-200 shadow-2xl z-20 flex flex-col p-6 space-y-6 overflow-y-auto">
      ...
      <section className="space-y-4 pt-4 border-t border-slate-100">
        ...
        <button
          onClick={onAddForbiddenArea}
          className="w-full bg-red-50 text-red-700 hover:bg-red-100 py-2.5 px-4 rounded-xl flex items-center justify-center gap-2 transition-all font-semibold border border-red-100"
        >
